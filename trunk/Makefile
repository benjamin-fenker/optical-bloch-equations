CC=g++
CFLAGS=-fopenmp -fpic -c -ansi -pedantic -Wall -O2 -W -Wconversion -Wshadow -Wpointer-arith -Wcast-qual -Wcast-align -Wwrite-strings -Werror -fshort-enums -fno-common -g
